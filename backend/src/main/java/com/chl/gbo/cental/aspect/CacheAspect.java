package com.chl.gbo.cental.aspect;
...
import com.chl.gbo.cental.aspect.annotation.CacheObj;
...
public class CacheAspect implements InitializingBean {
    ...
    @Pointcut("@annotation(com.chl.gbo.cental.aspect.annotation.Cache)")
    private void point(){}
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        ParserConfig.getGlobalInstance().addAccept("com.chl.gbo.cental.bean.");
        ParserConfig.getGlobalInstance().addAccept("com.chl.gbo.cental.config.");
        ParserConfig.getGlobalInstance().addAccept("com.chl.gbo.cental.domain.");
        ParserConfig.getGlobalInstance().addAccept("com.chl.gbo.cental.vo.");
    }
