var url = u+"/article/sort?sid="+UrlParm.parm("sid");
...
var L = {
    ...
    loadSort: function(data){
        ...
        A.switchBarClass(ar[0].sortId)
        $('.sonmenu').empty().append('<a href="article.html?sid='+ar[0].sortId+'" class="sonmenu">'+ar[0].sortName+'</a>');
